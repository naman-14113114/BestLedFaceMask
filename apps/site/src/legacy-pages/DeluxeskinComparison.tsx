...
const products = [
  ...
  },
  {
    ...
    isWinner: false,
    description: [
      "Taking the second spot is the DeluxeSkin Clinical Red Light Face Mask. This device positions itself as a \"med-spa\" style alternative, directly challenging big brands like Omnilux and CurrentBody by offering similar specifications at a lower price point.",
    ...
    pros: [
      ...
      "Dual Wavelengths: Uses a popular combination of 633nm (Red) and 830nm (Near-Infrared) light, wavelengths commonly associated with the look of fine lines.",
    ...
    cons: [
      "Higher Price, Fewer Features: At £199, it is more expensive than our top overall pick, yet it is restricted to just two wavelengths instead of a full multi-colour range.",
      ...
      "Missing Blue Light: This device is focused on anti-ageing routines and does not include the blue-light mode often sought by blemish-prone shoppers."
    ],
    metrics: [
      { label: "Light Coverage", value: 95 },
...
export default function DeluxeskinComparison({ context }: MarketContextProps) {
  return (
