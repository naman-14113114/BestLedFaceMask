...
const products = [
  {
    ...
    pros: [
      ...
      "7 Colour Spectrum: Unlike competitors that only offer 2 or 3 colours, Buudy features 7 visible colours plus <b>830nm near-infrared</b>. The exact wavelengths are 633nm red, 415nm blue, 525nm green, 490nm cyan, 590nm yellow, 390nm purple, 510nm white, and <b>830nm near-infrared</b> for deeper support.",
  ...
  },
  {
    ...
    description: [
      ...
      "In our experience, a single daily session is all that is required to see noticeable improvements in skin clarity and tone. The published brand materials and device positioning specifically excel at brightening the under-eye area, with users reporting that the cooling pads visibly reduce puffiness and refresh the complexion after just one use.",
    ],
    pros: [
    ...
    cons: [
      ...
      "Limited Light Modes: The mask is heavily focused on its cooling gimmick and offers very few light options. It is missing 5 of the 7 wavelengths (Green, Yellow, Cyan, Purple, White) that the Buudy mask has for targeting dark spots, skin balancing, and reducing swelling.",
      "Unspecified LED Count: The page does not clearly state the number of LEDs. Shoppers who care about even coverage may prefer a device with a published LED count.",
      ...
      "Limited Light Range: It is a 2-in-1 device with fewer light modes. A customer wanting to focus on the look of uneven tone (Green light) or balance skin texture (Yellow light) would get no benefit from this mask.",
    ],
    metrics: [
  ...
  },
  {
    ...
    description: [
      ...
      "Crucially, at this premium price, it entirely lacks neck and chest coverage. While it does provide convenience, the <b>162 LEDs</b> offer a lower density of light compared to modern high-output models, and it completely misses out on 5 vital colour options needed for comprehensive facial health, making it a pricey option compared to more feature-rich alternatives.",
    ],
    pros: [
      "Fastest Treatment Time: Completes a full session in just 3 minutes, ideal for those in a rush.",
      "Expert-Led Brand: Created by Dr. Dennis Gross, adding a layer of expert positioning.",
    ...
    cons: [
      ...
      'Zero Neck & Chest Coverage: For nearly £500, the lack of a neck attachment is a glaring omission. Users risk the "face-and-neck mismatch" aging effect, whereas better-value masks include neck and jawline coverage as a standard feature.',
      ...
      "Limited Colour Range: It offers only 3 modes (Red, Blue, and Combo). It completely misses out on Green (pigmentation), Yellow (redness), Cyan, Purple, and White light modes that come standard with Buudy.",
...
const customerReviews = [
  {
    ...
    location: "London",
    stars: 5,
    text: "After 2 weeks, my blemish-prone skin scars started fading noticeably. The 7 colour modes are a game-changer — I use blue for breakouts and red for fine lines. Worth every penny!",
    date: "3 days ago",
    verified: true,
  },
  {
...
const CTAButton = ({
  ...
  text: string;
  className?: string;
  variant?: "primary" | "secondary" | "competitor";
}) => {
      ...
      {[
        ...
        <React.Fragment key={unit.label}>
          ...
          <div className="bg-slate-900 text-white rounded-xl px-3 py-2 min-w-[56px]">
            <div className="text-2xl md:text-3xl font-black tabular-nums tracking-wider">
              {unit.value}
            </div>
      ...
      {visible && (
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">purchased a <b>Buudy LED Mask</b></p>
            <p className="text-xs text-emerald-600 font-semibold mt-1">
              {person.minutes} minutes ago
            </p>
          </div>
        </motion.div>
      )}
...
export default function Home({ context }: MarketContextProps) {
  ...
  const scrollToBuudy = () => {
    buudySectionRef.current?.scrollIntoView({
      behavior: "smooth",
      block: "start",
    });
  };
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="bg-slate-50 p-6 rounded-2xl text-left text-sm md:text-base text-slate-600 leading-relaxed border border-slate-100 shadow-sm mb-12 max-w-4xl mx-auto">
            <p>
              ...
              face-and-<b>neck coverage</b>, and were easy enough to use consistently
              at home.
            </p>
          </div>
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-3">
              ...
              <span className="font-bold text-emerald-700 uppercase text-sm tracking-wider">
                Our #1 Pick After 200+ Hours of Testing
              </span>
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg prose-slate max-w-4xl mx-auto mb-16">
          <p>
            ...
            make almost identical claims about collagen, blemish-prone skin, redness, and
            anti-ageing routine.
          </p>
          <p>
          ...
          <p>
            ...
            better everyday value. The best masks used the right wavelengths, gave even
            face and <b>neck coverage</b>, and were easy enough to use consistently at
            home.
          </p>
          <p>
            <em className="text-emerald-700 font-semibold not-italic">
              One mask stood out dramatically — scoring 97% in almost every
              category while costing less than half the competition. Here&apos;s
              the full breakdown.
            </em>
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-200 mb-16 max-w-5xl mx-auto overflow-x-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-8 text-center font-serif">
            At-a-Glance Comparison
          </h2>
          <table className="w-full text-sm md:text-base border-collapse">
            <thead>
              <tr className="border-b-2 border-slate-200">
                <th className="text-left py-3 px-2 md:px-4 font-bold text-slate-500 uppercase text-xs tracking-wider">
                  Mask
                </th>
                ...
                <th className="text-center py-3 px-2 md:px-4 font-bold text-slate-500 uppercase text-xs tracking-wider hidden sm:table-cell">
                  LEDs
                </th>
                <th className="text-center py-3 px-2 md:px-4 font-bold text-slate-500 uppercase text-xs tracking-wider">
                  Neck
            ...
            <tbody>
              {localizedProducts.map((p) => (
                ...
                >
                  ...
                  <td
                    className={`text-center py-3 px-2 md:px-4 hidden sm:table-cell ${p.isWinner ? "text-emerald-700 font-bold" : ""}`}
                  >
                    {p.ledCount ?? "—"}
                  </td>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-200 mb-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <ChevronDown
              size={24}
              className={`text-slate-400 transition-transform duration-300 shrink-0 ml-4 ${criteriaOpen ? "rotate-180" : ""}`}
            />
          </button>
            ...
            {criteriaOpen && (
              ...
              >
                ...
                <p className="text-center text-slate-600 bg-slate-50 p-4 rounded-xl border border-slate-100">
                  Over the past three months, we have thoroughly tested 18
                  different LED face masks. Based on hands-on evaluations,
                  published skincare research, and thousands of
                  consumer reviews, the following five models stood out as the
                  best in terms of performance, comfort, safety, and
                  affordability.
                </p>
              </motion.div>
            )}
              ...
              <div className="lg:col-span-4 flex flex-col items-center">
                <div className="lg:sticky lg:top-8 w-full flex flex-col items-center">
                  ...
                  <div className="text-center mb-4 w-full">
                    <div className="flex items-center justify-center gap-3 mb-1">
                      ...
                      <span className="text-lg text-slate-400 line-through font-medium">
                        {winnerProduct.originalPrice}
                      </span>
                    </div>
                    {/* ===== CRO #12: Offer Indicator ===== */}
                    <div className="flex items-center justify-center gap-1.5 text-emerald-600 text-sm font-bold mb-2">
                      <Zap size={14} />
                      <span>Free gifts included with every mask</span>
                    </div>
                    <GreenStarRating
                  ...
                  <div className="w-full hidden lg:block">
                    <CTAButton
                      href={winnerProduct.link}
                      text="See Full Details on Buudy.com"
                      className="w-full"
                    />
                  </div>
                </div>
                      ...
                      <div className="bg-emerald-50/50 rounded-2xl p-4 border border-emerald-100">
                        ...
                        <ul className="space-y-2.5">
                          {mobilePros.map((pro, idx) => (
                            <li
                              key={idx}
                              className="text-sm text-slate-700 flex items-start gap-2.5 leading-snug"
                            >
                              <Check
                                size={16}
                                className="text-emerald-500 shrink-0 mt-0.5"
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-8">
                      While doing our research, we found that Buudy is currently
                      running a limited-time sale where you can get these
                      premium accessories bundled for free with every mask
                      purchase.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                      ...
                      <div className="bg-white rounded-2xl p-4 border border-blue-100 shadow-lg text-center transform hover:-translate-y-1 transition-transform relative">
                        ...
                        <div className="relative mb-3 rounded-xl overflow-hidden bg-gray-50 border border-slate-100">
                          <span className="absolute bottom-2 left-1/2 -translate-x-1/2 text-gray-500 font-bold line-through z-10 bg-white/90 px-3 py-1 rounded-full text-xs shadow-sm">
                            Normally £39
                          </span>
                          <img
                            src="/img/93-w.webp"
                      ...
                      <div className="bg-white rounded-2xl p-4 border border-blue-100 shadow-lg text-center transform hover:-translate-y-1 transition-transform relative mt-4 sm:mt-0">
                        <div
                          className="absolute -top-4 -right-2 bg-blue-600 text-white font-black text-sm md:text-base px-4 py-1.5 rounded-full shadow-lg z-20 animate-bounce"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="relative">
                  <div className="relative mx-auto max-w-[260px] sm:max-w-[280px] md:max-w-[300px] overflow-hidden rounded-[1.75rem] border border-[#dfd1bd] bg-black shadow-xl">
                    ...
                    <button
                      type="button"
                      aria-label="Play skincare professional walkthrough video"
                  ...
                  <p className="mt-4 text-center text-sm font-medium text-gray-600">
                    See the light modes, fit, eye area, and full-face coverage
                    in a real product walkthrough.
                  </p>
                </div>
