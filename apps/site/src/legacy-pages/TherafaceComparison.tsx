...
const products = [
  ...
  },
  {
    ...
    pros: [
      "Massive LED Count: Features <b>648 LEDs</b>, providing extremely high-density light coverage across the face.",
...
export default function TherafaceComparison({ context }: MarketContextProps) {
  return (
