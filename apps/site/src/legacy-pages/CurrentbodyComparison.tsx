...
const products = [
  ...
  },
  {
    ...
    pros: [
      "90-Day Guarantee: Offers a <b>90-day money-back guarantee</b>.",
      "Anti-Ageing Focus: The brand markets the device around the appearance of fine lines and wrinkles.",
