  ...
  return (
    <Layout>
      <article className="mx-auto max-w-3xl px-4 py-16 text-slate-700">
        ...
        <p className="mt-4 leading-relaxed">Our guides focus on stated wavelengths, face and neck coverage, fit, treatment time, eye protection, warranty or return policies, current price and local availability. Country pages use market-specific currencies and retailer destinations.</p>
